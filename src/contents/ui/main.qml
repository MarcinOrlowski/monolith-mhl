...
WallpaperItem {
    ...
    property real showMaskSpark: 0.0
    property real maskSparkRadius: 8.0
    property real maskSparkThreshold: 0.3
    property real maskSparkStrength: 1.0
    ...
    ShaderEffect {
        ...
        property real showMaskSpark: root.showMaskSpark
        property real maskSparkRadius: root.maskSparkRadius
        property real maskSparkThreshold: root.maskSparkThreshold
        property real maskSparkStrength: root.maskSparkStrength
