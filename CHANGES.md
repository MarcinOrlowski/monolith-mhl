...
- New "Microscope Zoom" effect: an endless, constant-speed forward zoom into a microscopic world, with adjustable floating dust.
...
- Animation can be paused using desktop context menu.
- Added more documentation to the project.

## v1.0.0 (2026-03-27)

- Initial release with Rainbow Waves effect.
